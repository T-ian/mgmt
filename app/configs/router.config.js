...
export default () => (
  <Router history={hashHistory}>
    <Route path="/" component={base.app} onEnter={isLogin}>
      ...
      <Route path="/act/create" component={base.createAct} />
      <Route path="/act/type" component={base.actType} />
      <Route path="/act/query" component={base.queryConf} />
      <Route path="/act/reward" component={base.rewardConf} />
      <Route path="/act/entry" component={base.entryConf} />
      <Route path="/act/generate" component={base.actGen} />
